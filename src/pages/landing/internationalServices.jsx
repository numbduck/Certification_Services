...
import ISI_image from "../../assets/ISO_9001.jpg";
import ISI_logo from "../../assets/ISO_logo.png";
      ...
      <div className={styles.Container} >
        ...
        <Box className={styles.box}>
          <Box className={styles.home} pt='1rem'>
            ...
            <Box>International Compliances</Box>
          </Box>
          ...
          <Box background="white">
            <Tabs variant="unstyled">
              ...
              >
                <Tab _selected={{ bg: "gray.400" }}>ISO 9001</Tab>
                <Tab _selected={{ bg: "gray.400" }}>ISO 14001</Tab>
          ...
          <Box className={styles.crmImg}>
            <Box align="left" w="50%" mr="2rem" ml="1rem">
              <Text mb="12px" fontSize="21px" fontWeight="600" color="gray.700">
                Looking for different compliances?
              </Text>
              <Text
                fontSize="16px"
                fontWeight="500"
                ...
                color="gray.500"
              >
                InstaCertify's platform also offers enterprise software for
